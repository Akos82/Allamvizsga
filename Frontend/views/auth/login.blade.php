...
<head>
    ...
    <title>Bejelentkezés – Planetárium</title>
...
<body class="h-full flex items-center justify-center font-sans" style="min-height:100vh;">
    ...
    <div class="relative z-10 px-6" style="width:100%;max-width:420px;">
        ...
        <div class="bg-white rounded-2xl shadow-2xl shadow-black/40 p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-1">Bejelentkezés</h2>
            <p class="text-gray-500 text-sm mb-6">Nincs fiókod? <a href="{{ route('register') }}" class="text-brand-600 font-medium hover:underline">Regisztrálj</a></p>
