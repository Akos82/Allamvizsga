...
<head>
    ...
    <title>Regisztráció – Planetárium</title>
...
<body class="h-full flex items-center justify-center font-sans py-8" style="min-height:100vh;">
    ...
    <div class="relative z-10 w-full max-w-md px-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl shadow-black/40 p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-1">Regisztráció</h2>
            <p class="text-gray-500 text-sm mb-6">Már van fiókod? <a href="{{ route('login') }}" class="text-brand-600 font-medium hover:underline">Jelentkezz be</a></p>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Jelszó <span class="text-gray-400 font-normal">(min. 8 karakter)</span></label>
